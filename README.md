...
| [pangeo-notebook](https://github.com/pangeo-data/pangeo-docker-images/tree/master/pangeo-notebook) <br/> ![](https://img.shields.io/docker/image-size/pangeo/pangeo-notebook?sort=date) <br/>                                     | Pangeo Notebook  <br/> <small>docker.io/pangeo/pangeo-notebook:latest</small>                                                                                       | [![Button GCS](https://img.shields.io/badge/launch-codespace-brightgreen?logo=github)](https://codespaces.new/nmfs-opensci/container-images?devcontainer_path=.devcontainer/pangeo-notebook/devcontainer.json)               | [directory](https://github.com/pangeo-data/pangeo-docker-images/tree/master/pangeo-notebook)                   |
| [test](https://github.com/nmfs-opensci/container-images/pkgs/container/container-images%2Ftest) <br/> ![](https://ghcr-badge.egpl.dev/nmfs-opensci/container-images%2Ftest/size?color=%2344cc11&tag=latest&label=image+size&trim=) <br/> ![](https://ghcr-badge.egpl.dev/nmfs-opensci%2Fcontainer-images/test/latest_tag?color=%2344cc11&ignore=latest&label=version&trim=) |
| [openscapes-python](https://github.com/NASA-Openscapes/corn) <br/> ![](https://img.shields.io/docker/image-size/openscapes/python?sort=date) <br/>                                     | Openscapes Python    <br/> <small>docker.io/openscapes/python:07980b9 </small>  |               | [directory](https://github.com/NASA-Openscapes/corn/tree/main/ci)                  |
