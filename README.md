...
| [py-rocket-test](https://github.com/nmfs-opensci/container-images/pkgs/container/container-images%2Fpy-rocket-test) <br/> ![](https://ghcr-badge.egpl.dev/nmfs-opensci/container-images%2Fpy-rocket-test/size?color=%2344cc11&tag=latest&label=image+size&trim=) <br/> ![](https://ghcr-badge.egpl.dev/nmfs-opensci%2Fcontainer-images/py-rocket-test/latest_tag?color=%2344cc11&ignore=latest&label=version&trim=) | Geospatial Python (3.12) and R (4.4.3) image with Desktop (QGIS)<br/> <small>ghcr.io/nmfs-opensci/container-images/py-rocket-test:latest</small> | <br/> | [dockerfile](https://github.com/nmfs-opensci/container-images/tree/main/images/py-rocket-test/Dockerfile) <br/> [directory](https://github.com/nmfs-opensci/container-images/tree/main/images/py-rocket-test) |
