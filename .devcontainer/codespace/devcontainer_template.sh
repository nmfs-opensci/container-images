...
message="{
  ...
  \"postCreateCommand\": \"echo '[![](https://img.shields.io/badge/Open%20Jupyter%20Lab-37a779?style=for-the-badge){height=100}](https://'\${CODESPACE_NAME}'-8889.app.github.dev)' > README.md && echo 'PWD=/home/jovyan\ncd \${PWD}' >> ~/.bash_login\",
