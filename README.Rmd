...
#    desc <- readLines(fil, warn=FALSE)
  ...
  branch <- system(paste0("git show-ref refs/remotes/origin/", i, " ignore.stdout = TRUE"))
  binder_button <- ""
  ...
  cat("| [", i, "](https://github.com/nmfs-opensci/container-images/pkgs/container/container-images%2F", i, ")  | ", desc, "<br/> <small>ghcr.io/nmfs-opensci/container-images/", i, ":latest</small> | ", devcon_button, " <br/> ", binder_button, " |  [dockerfile](https://github.com/nmfs-opensci/container-images/tree/main/images/", i, "/Dockerfile) <br/> [directory](https://github.com/nmfs-opensci/container-images/tree/main/images/", i, ") |\n", sep="")
}
```
...
-   Example `FROM ghcr.io/nmfs-opensci/container-images/py-rocket-geospatial-2:latest`
...
In the table, you can click on Launch Codespace to launch an image in GitHub Codespaces. If the launch reports an error, use Cmd/Cntl-Shift-P and select Rebuild. You should see a pop-up to ask you to launch JupyterLab in a browser, but if not open a terminal, click Ports, and click on the browser link for JupyterLab.
